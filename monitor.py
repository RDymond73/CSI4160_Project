...
while status == 'running':
    ...
    if temperature > baseline + upper_variance:
        ...
        sense.show_message('RED ALERT: ' + str(temperature) + ' *F', text_colour=red)
        summary = sensehat.main('alert')
        baseline = int(summary[0])
        upper_variance = int(summary[1])
        lower_variance = int(summary[2])
        ...
        sense.show_message('BLUE ALERT: ' + str(temperature + ' *F'), text_colour=blue)
        summary = sensehat.main('alert')
        baseline = int(summary[0])
        upper_variance = int(summary[1])
        lower_variance = int(summary[2])
        ...
        sense.show_message('SAFE: ' + str(temperature) + ' *F', text_colour=green)
        summary = sensehat.main('alert')
        baseline = int(summary[0])
        upper_variance = int(summary[1])
        lower_variance = int(summary[2])
